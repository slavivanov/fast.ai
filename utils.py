...
def plot_files(filepaths, images_per_row=None, figsize=(12,6), 
    ...
    num_files = np.asarray(filepaths).shape[0]
    ...
    while index < num_files:
        ...
        images = [Image.open(filepath) for filepath in filepaths[start:end]]
        plots(images, figsize=figsize, rows=rows, interp=interp, 
